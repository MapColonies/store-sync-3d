...
import { CreateJobBody, IJobParameters, IExportResponse, ITaskParameters, JobResponse } from '../common/interfaces';
...
export class JobManagerWrapper extends JobManagerClient {
  ...
  public async create(job: CreateJobBody, files: string[]): Promise<IExportResponse> {
    ...
    const tasks: ICreateTaskBody<ITaskParameters>[] = filesToTasks(files);
    job.tasks = tasks;
